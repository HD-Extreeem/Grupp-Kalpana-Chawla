...
* @file TWIComm.c
*
* @brief This source file handle the communication through I2C communication between Arduino
*		 Send request and handles request events when received
*
* @author Jonas Eiselt
*
* @date 2017-05-11 09:59:55
* 
*/
