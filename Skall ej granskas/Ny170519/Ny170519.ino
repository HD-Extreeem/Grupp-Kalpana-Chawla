...
void setup()
{
  ...
  */
  ...
  //---------------------------------------------------
    ...
    servoArm.write(150);              // tell servo to go to position in variable 'pos'
...
/*
  ...
  */
   ...
   switch (current_state) {
    ...
    /*
      case Find:
       ...
       //När roboten kommit fram till objektet blir nästa state att gå in i LiftDown
    ...
    */
    ...
    //Enter this case when the Robot is at the objects cordinates.The lift goes down.
    case LiftDown:
